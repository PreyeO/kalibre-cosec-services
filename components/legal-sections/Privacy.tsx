      ...
      <div className=" max-w-[1133px] flex flex-col">
        <div className="flex flex-col md:gap-[25px] gap-4 md:pb-[50px] pb-6">
          ...
          <BodyContent className="md:text-lg md:leading-[26px] text-[#3A3A3A] text-sm leading-[22px]">
            This is the Kalibre CoSec Limited (“Kalibre CoSec,” “we,” “us,” or
            “our”) Privacy Policy. This Privacy Policy applies to our website{" "}
            {""}
            <a
            ...
            access or use them. Kalibre CoSec respects your privacy and is
            committed to protecting your personal data. This privacy notice will
            inform you as to how we look after your personal data and tell you
            about your privacy rights and how the law protects you.
          </BodyContent>
          <BodyContent className="md:text-lg md:leading-[26px] text-[#3A3A3A] text-sm leading-[22px]">
            {" "}
            Kalibre CoSec respects your privacy and is committed to protecting
            your personal data. This Privacy Policy explains how we collect,
            use, disclose and safeguard your information in compliance with
            global data protection laws including the General Data Protection
        ...
        partners, to enhance our records and services."
          ...
          <TextGroup
            ...
            vital interests, or legitimate interests pursued by Kalibre CoSec or a third party. We always 
          ...
          />
          <TextGroup
            content="Kalibre CoSec may share your information with trusted service providers, such as IT hosts, 
          ...
          />
          <TextGroup
            content="As a global company, Kalibre CoSec may transfer personal data to countries outside your 
          ...
          />
          <TextGroup
            content="Kalibre  CoSec retains your personal data only for as long as necessary to fulfill the 
