...
const ConnectWithUs = () => {
  return (
    <section className=" contact-bg relative z-0 md:pb-[105px]  ">
      <div className=" mx-[21px] md:mx-0 flex justify-center md:gap-[38px] items-center pt-[50px] md:flex-nowrap flex-wrap ">
        <CareerForm />
        <div className="max-w-[573px] md:pr-[91px] md:h-[266px] flex flex-col justify-center md:gap-6 gap-[10px] md:backdrop-blur-[10px] border border-white/60 md:shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] rounded-[20px] md:py-[50px] py-4 md:pl-[50px] ">
          <Heading
