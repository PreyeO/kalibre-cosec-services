...
const HeroButton: React.FC<HeroButtonProps> = ({ label }) => {
  ...
  return (
    <Button
      ...
      className="z-10 md:mt-[6px] mt-0 bg-[#F67D30] hover:bg-[#F67D30] text-white py-6 px-6 cursor-pointer rounded-[30px] font-medium font-primary text-sm flex items-center gap-[10px] group"
    >
      {" "}
      {label}
